...
switch ($sort) {
    ...
    case 'weight_desc':
        ...
        break;
    case 'boost':
        $orderBy = 'boost DESC, name ASC'; // Sort by boost status first, then by name
        break;
    case 'favorites':
...
// Prepare SQL query with sorting, pagination, and favorites filtering
$query = "
    SELECT p.*, 
    ...
    <div class="container mt-4 p-4">
        ...
        <form method="GET" id="sorting-form">
            ...
            <select name="sort" id="sort-by" onchange="document.getElementById('sorting-form').submit();">
                ...
                <option value="boost" <?= (isset($_GET['sort']) && $_GET['sort'] === 'boost') ? 'selected' : '' ?>>Boosted Products</option>
